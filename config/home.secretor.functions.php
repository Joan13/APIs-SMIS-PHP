<?php
	...
	function insert_pupil($arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7, $arg8, $arg9, $arg10, $arg11, $arg12, $arg13, $arg14, $arg15, $arg16, $arg17, $arg18, $arg19, $arg20, $arg21, $arg22, $arg23, $arg24, $arg25, $arg26, $stat)
	{
		...
		if($count_pupil_exists_response->pupil_exists == 0) {
			...
			$request->execute(array($arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7, $arg8, $arg9, $arg10, $arg11, $arg12, $arg13, $arg14, $arg15, $arg16, $arg17, $arg18, $arg19, $arg20, $arg21, $arg22, $arg23, $arg24, $arg25, $arg26, $stat, 0, "", "", ""));
		}
	}
	...
	function insert_course($arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7)
	{
		...
		if($res == 0)
		{
			$query = "INSERT INTO courses(course_name, cycle_id, class_id, section_id, option_id, total_marks, considered, school_year)
						VALUES(?, ?, ?, ?, ?, ?, ?, ?) ";
			$request = $database_connect->prepare($query);
