...
<div class="show_third_party_caisse" style="text-align: left;">
	<div style="color: white; padding-left: 25px;" id="left_div">
	    ...
	    <div class="liste_libelle" style="color: black;">
	        <p class="title_libs" style="font-weight: bold;">APERCUS GENERAUX DE DISCIPLINE</p><br/>
	        ...
	        <div id="refresh_table_l">
	            <a id="refresh_table_lib" style="text-decoration: underline;background-color: inherit; width: 90%; font-weight: bold;" href="./?_=home.director">ACTUALISER LA TABLE DES APERCUS</a>
	        </div>
