				...
				<table style="border-collapse:collapse;border:1px solid rgba(0, 0, 0, 0.2);">
					<tr>
						...
						<td style="padding-left:15px;border:1px solid rgba(0, 0, 0, 0.2);">
							...
							<select class="selects select_pupil_option" id="course_attributed">
								...
								if(count_classes_completed_exist() != 0)
								{
									...
									while($query_fetch = $query_fetch11->fetchObject())
									{
										...
										?>
										<button id="validate_insert_worker" class="validate_login"></button>
							...
							<select class="selects select_pupil_option" id="course_attributed">
								...
								if(count_classes_completed_exist() != 0)
								{
									...
									while($query_fetch = $query_fetch11->fetchObject())
									{
										...
										?>
											<option value="<?= $query_fetch->class_completed_id ?>"><?= $class_number ."". $order_name ."". $section_name ?></option>
										<?php
									}
								}
							...
							<br/><br/><br/><br/>
							<span style="color:gray;">Actualiser la page avant de proceder a l'attribution d'un cours.</span><br/><br/><br/>
						</td>
					</tr>
