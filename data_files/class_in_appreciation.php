...
<div class="main_middle_container">
	...
	<strong style="font-size: 14px;"><?= strtoupper($school_bp) ?></strong>
					...
					<td style="padding: 15px;padding-left: 0px; padding-top: 0px;border: none;">
						...
						<strong style="text-align: center;font-size: 14px;">FICHE APPRECIATION DU JURY : <?=$class_identity?></strong>
					</td>
				</tr>
			</table>
	...
	<table style="border-collapse: collapse;min-width:70%;text-align: center;" class="class_table">
		<tr>
			...
			<th style="text-align:left;padding-left: 5px; width: 300px;border: 1px solid black;font-size: 12px;">Noms et postnoms</th>
			<th style="text-align:left;padding-left: 5px; width: 60px;text-align: center;border: 1px solid black;font-size: 12px;">%</th>
			<th style="text-align:left;padding-left: 5px; width: 300px;text-align: center;border: 1px solid black;font-size: 12px;">APPRECIATION</th>
			<th style="text-align:left;padding-left: 5px; width: 500px;text-align: center;border: 1px solid black;font-size: 12px;">OBSERVATION</th>
		</tr>
		<?php
		...
		if(count_pupils_exist($_GET['cycle'], $_GET['class_id'], $_GET['order_id'], $_GET['section_id'], $_GET['option_id'], $_GET['school_year']) != 0)
		{
			...
			while($query_fetch = $query_fetch11->fetchObject())
			{
				...
				?>
				<tr>
					<td style=" text-align: left;padding-left: 5px; width: 10px;border: 1px solid black;font-size: 12px;">
						<span class="a_pupilsfont-size: 12px;" ><?=$number?></span>
					</td>
