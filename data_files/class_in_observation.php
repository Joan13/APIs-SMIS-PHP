...
<div class="main_middle_container">
	...
	<strong style="font-size: 14px;"><?= strtoupper($school_bp) ?></strong>
					...
					<td style="padding: 15px;padding-left: 0px; padding-top: 0px;border: none;">
						...
						<strong style="text-align: center;font-size: 14px;">FICHE D'OBSERVATION DES POINTS OBTENUS : <?=$class_identity?></strong>
					</td>
				</tr>
			</table>
	<table style="border-collapse: collapse;min-width:100%;text-align: center;" class="class_table">
		<thead>
			<tr>
				<th style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;">No</th>
				<th style="text-align:left;padding-left: 5px; width: 500px;border: 1px solid black;">Noms et postnoms</th>
				
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">P1</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">cond.</th>
				<th style="text-align:left;padding-left: 5px; width: 200px;border: 1px solid black;">Observation</th>

				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">P2</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">cond.</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">TS1</th>
				<th style="text-align:left;padding-left: 5px; width: 200px;border: 1px solid black;">Observation</th>

				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">P3</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">cond.</th>
				<th style="text-align:left;padding-left: 5px; width: 200px;border: 1px solid black;">Observation</th>

				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">P4</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">cond.</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">TS2</th>
				<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">TG</th>
				<th style="text-align:left;padding-left: 5px; width: 200px;border: 1px solid black;">Observation</th>

				<th style="text-align:left;padding-left: 5px; width: 100px;border: 1px solid black;">Decision</th>
			</tr>
		</thead>
		<?php
		...
		if(count_pupils_exist($_GET['cycle'], $_GET['class_id'], $_GET['order_id'], $_GET['section_id'], $_GET['option_id'], $_GET['school_year']) != 0)
		{
			...
			while($query_fetch = $query_fetch11->fetchObject())
			{
				...
				<tr>
					...
					<td style=" text-align: left;padding-left: 5px;border: 1px solid black;font-size: 12px;">
						<span><?=strtoupper($query_fetch->first_name). " ".strtoupper($query_fetch->second_name)?></span>
					</td>
