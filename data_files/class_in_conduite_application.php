	...
	<table style="width: 100%; border-collapse: collapse;border: none;">
		<tr>
			...
			<td style="padding: 15px;padding-left: 0px; padding-top: 0px;border: none;">
				...
				<strong style="text-align: center;font-size: 14px;">FICHE DE CONDUITE ET APPLICATION : <?=$class_identity?></strong>
			</td>
		</tr>
	</table>

	<table style="border-collapse: collapse;min-width:70%;text-align: center;font-size: 12px;" class="class_table">
		<tr>
			<th rowspan="2" style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;font-size: 12px;">No</th>
			<th rowspan="2" style="text-align:left;padding-left: 5px; width: 400px;border: 1px solid black;">Noms et postnoms</th>
			<th colspan="2" style="text-align:center;padding-left: 5px; width: 70px;border: 1px solid black;">1e Per.</th>
			<th style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;"></th>

			<th colspan="2" style="text-align:center;padding-left: 5px; width: 70px;border: 1px solid black;">2e Per.</th>
			<th style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;"></th>

			<th colspan="2" style="text-align:center;padding-left: 5px; width: 70px;border: 1px solid black;">3e Per.</th>
			<th style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;"></th>

			<th colspan="2" style="text-align:center;padding-left: 5px; width: 70px;border: 1px solid black;">4e Per.</th>
		</tr>
		<tr>
			<!-- <th style="text-align:left;padding-left: 5px; width: 50px;"></th>
			<th style="text-align:left;padding-left: 5px; width: 400px;"></th> -->
			<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">Appl.</th>
			<th style="text-align:left;padding-left: 5px; width: 70px;border: 1px solid black;">cond.</th>
			<th style="text-align:left;padding-left: 5px; width: 50px;border: 1px solid black;"></th>
		...
		if(count_pupils_exist($_GET['cycle'], $_GET['class_id'], $_GET['order_id'], $_GET['section_id'], $_GET['option_id'], $_GET['school_year']) != 0)
		{
			...
			while($query_fetch = $query_fetch11->fetchObject())
			{
				...
				<td style=" text-align: left;padding-left: 5px; width: 10px;border: 1px solid black;">
						<span class="a_pupils" ><?=$number?></span>
					</td>
					<td style=" text-align: left;padding-left: 5px;border: 1px solid black;">
						<span class="a_pupils"><?=strtoupper($query_fetch->first_name). " ".strtoupper($query_fetch->second_name)?></span>
					</td>
					...
					<?php
						for($i = 0; $i <= 10; $i++) {
							...
							<td style="border: 1px solid black;background-color: rgba(0, 0, 0, 0.1);"></td>
