...
<div class="main_middle_container">
	<h2 style="text-align: center;">Fiche des identités des élèves de la <?=$class_identity?>  / <u class="printFicheClasse" style="cursor: pointer;">Imprimer la fiche</u></h2>
	...
	<table style="border-collapse: collapse;min-width:100%;text-align: center;" class="class_table">
		<tr>
			...
			<th style="text-align:left;padding-left: 5px; width: 150px;height: 10px;">Prénom</th>
			...
			<th style="text-align:left;padding-left: 5px; width: 400px;height: 10px;">Noms père</th>
			<th style="text-align:left;padding-left: 5px; width: 400px;height: 10px;">Noms mère</th>
			<th style="text-align:left;padding-left: 5px; width: 100px;height: 10px;">Nationalité</th>
