...
<div class="main_middle_container">
	<h2 style="text-align: center;">Fiche des points de la <?=$class_identity?>  / <u class="printFicheClasse" style="cursor: pointer;">Imprimer la fiche</u></h2>
	...
	<h2 style="text-align: center;">Fiche des points : <?=$class_identity?></h2>
	<table style="border-collapse: collapse;min-width:70%;text-align: center;" class="class_table">
		<tr>
			<th colspan='2' style="text-align:left;padding-left: 5px; width: 300px;">
				Branche<br/><br/><br/><br/>
				TITULAIRE
			</th>
			<?php
		...
		<tr>
			...
			<th style="text-align:left;padding-left: 5px; width: 200px;">Noms et post-noms</th>
		</tr>
		<?php
