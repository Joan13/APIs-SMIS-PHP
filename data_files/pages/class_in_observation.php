...
<div class="main_middle_container">
	<h2 style="text-align: center;">Fiche d'observation des points obtenus <?=$class_identity?>  / <u class="printFicheClasse" style="cursor: pointer;">Imprimer la fiche</u></h2>
	...
	<h2 style="text-align: center;">FICHE D'OBSERVATION DES POINTS OBTENUS : <?=$class_identity. " ".$school_year?></h2>
	<table style="border-collapse: collapse;min-width:100%;text-align: center;" class="class_table">
		<tr>
			...
			<th style="text-align:left;padding-left: 5px; width: 500px;">Noms et postnoms</th>
