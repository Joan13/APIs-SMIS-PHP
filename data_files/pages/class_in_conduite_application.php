...
<div class="main_middle_container">
	<h2 style="text-align: center;">Fiche de conduite et application de la <?=$class_identity?>  / <u class="printFicheClasse" style="cursor: pointer;">Imprimer la fiche</u></h2>
	...
	<h2 style="text-align: center;">FICHE DE CONDUITE ET APPLICATION : <?=$class_identity?></h2>
	<table style="border-collapse: collapse;min-width:70%;text-align: center;" class="class_table">
		<tr>
			...
			<th style="text-align:left;padding-left: 5px; width: 400px;">Noms et postnoms</th>
