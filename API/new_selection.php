...
$query = "INSERT INTO selections(selection_name, selection_type, selection_privacy, user_id, school_year, selection_data)
				VALUES('$selection_name', '$selection_type', '$selection_privacy', '$user_id', '$school_year', '$selection_data')";
